...
class licoresimportados extends StatefulWidget {
  ...
  @override
  State<licoresimportados> createState() => _licoresimportadosState();
}

// ignore: camel_case_types
class _licoresimportadosState extends State<licoresimportados> {
  ...
  final TextEditingController tipo = TextEditingController(text: "licores importados");
  File? _imagen;
