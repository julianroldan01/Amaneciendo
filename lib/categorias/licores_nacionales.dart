...
class licoresnacionales extends StatefulWidget {
  ...
  @override
  State<licoresnacionales> createState() => _licoresnacionalesState();
}

// ignore: camel_case_types
class _licoresnacionalesState extends State<licoresnacionales> {
  ...
  final TextEditingController tipo = TextEditingController(text: "licores nacionales");
  File? _imagen;
