...
class cervezaimportada extends StatefulWidget {
  ...
  @override
  State<cervezaimportada> createState() => _cervezaimportadaState();
}

// ignore: camel_case_types
class _cervezaimportadaState extends State<cervezaimportada> {
  final url = Uri.parse("http://192.168.20.25:4000/api/carta/2");
  ...
  final TextEditingController tipo = TextEditingController(text: "cerveza importada");
  File? _imagen;
                ...
                Row(
                  children: <Widget>[
                    Container(
                      ...
                      child: const Text("CERVEZA IMPORTADA",
                          style: TextStyle(
                              color: Colors.white,
                              fontFamily: "Acme",
                              fontSize: 25.0,
